...
class _FeedScreenState extends State<FeedScreen> with WidgetsBindingObserver {
  ...
  Future<void> _refreshRemoteCards() async {
    ...
    try {
      ...
      // Keep cached cards when offline.
    } finally {
      _refreshing = false;
    }
  }
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              total == 0 ? 'Start with one card.' : '${((_sessionCompleted / total) * 100).round()}% of cards felt worth doing.',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          padding: EdgeInsets.fromLTRB(20, keyboardOpen ? 8 : 18, 20, keyboardOpen ? 6 : 14),
          child: Column(
            children: [
              if (!keyboardOpen)
                Row(
                  children: [
                    ...
                    const Spacer(),
                    TextButton(onPressed: _showSession, child: Text('$_completed useful')),
                  ],
                ),
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        transform: Matrix4.identity()
                          ...
                          ..rotateZ(_drag.dx / max(constraints.maxWidth, 1) * .035),
                                  ...
                                  children: [
                                    ...
                                    if (isWriting) ...[
                                      ...
                                      TextField(
                                        ...
                                        minLines: keyboardOpen ? 1 : 2,
                                        maxLines: keyboardOpen ? 3 : 5,
                              ...
                              children: [
                                Expanded(
                                  child: OutlinedButton(
                                    ...
                                    style: OutlinedButton.styleFrom(minimumSize: Size.fromHeight(keyboardOpen ? 46 : 52)),
                                ...
                                Expanded(
                                  child: FilledButton(
                                    ...
                                    style: FilledButton.styleFrom(minimumSize: Size.fromHeight(keyboardOpen ? 46 : 52)),
